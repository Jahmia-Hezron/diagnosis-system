...
import 'package:frontend/screens/home/screens/dashboard.dart';
import 'package:frontend/screens/home/screens/test_results.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget buildSideMenu(ColorScheme colorScheme) {
    return Material(
      child: ListView(padding: const EdgeInsets.all(21.0), children: [
        _buildListTile('Dashboard', 0, colorScheme),
        _buildListTile('Test Results', 1, colorScheme),
        _buildExpansionTile(title: 'Tests', children: [
          _buildListTile('Autism Test', 2, colorScheme),
          _buildListTile('Depression Test', 3, colorScheme),
        ])
      ]),
    );
  }
